...
Gunakan bahasa sesuai teks terjemah yang ringkas, jelas, dan mudah dipahami.

Jika terdapat perbedaan pendapat ulama yang penting, sebutkan secara singkat,

Ikuti format Markdown berikut SECARA PERSIS.

ATURAN FORMAT:
1. Judul utama HARUS menggunakan `##`.
2. Semua section HARUS menggunakan `###`.
3. Jangan gunakan `#` atau `####`.
4. Jangan gunakan bold (`**`) untuk judul section.
